      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl mb-8">
            Founded in 2020, Malabar Kombucha began with a simple mission: to create the most delicious,
            healthful kombucha using traditional brewing methods and the finest organic ingredients.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12">
            <div className="p-6 rounded-lg" style={{ 
              ...
              <p>We use only organic ingredients and traditional brewing methods to ensure the highest quality kombucha.</p>
            </div>
            <div className="p-6 rounded-lg" style={{ 
              backgroundColor: 'var(--accent-color)20',
              border: '1px solid var(--accent-color)40'
              ...
              <p>Our brewing process is designed to minimize waste and environmental impact.</p>
            </div>
            <div className="p-6 rounded-lg" style={{ 
              backgroundColor: 'var(--accent-color)20',
              border: '1px solid var(--accent-color)40'
              ...
              <p>We're committed to building a community around healthy living and sustainable practices.</p>
            </div>
          </div>
        </div>
      </section>
